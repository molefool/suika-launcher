   ...
   private slots:
    ...
    void test_bmclapiDoesNotRewriteUnrelatedHosts()
    {
        const QList<QUrl> urls = {
            ...
            QUrl("https://meta.fabricmc.net/v2/versions/loader"),
            QUrl("https://meta.quiltmc.org/v3/versions/loader"),
            QUrl("https://maven.neoforged.net/api/maven/details/releases/net/neoforged/neoforge"),
